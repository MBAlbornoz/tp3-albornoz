...
<asp:Label ID="lblIngreso" CssClass="textIngreso" runat="server">Ingrese su numero de Documento</asp:Label>
 <h1></h1>
<asp:TextBox ID="TextVerDNICl" MaxLength="8" Width="605px" Height="30px" AutoPostBack="true" BorderColor="Black" BorderStyle="Double" ValidateRequestMode="Enabled" runat="server"></asp:TextBox>
